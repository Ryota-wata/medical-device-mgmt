...
// ──────────────────────────────────────────────
// VendorEntry型（購入管理rfq-processと同一パターン）
// ──────────────────────────────────────────────
...
function DisposalTaskContent() {
  ...
  // STEP①用：業者リスト（購入管理rfq-processと同一パターン）
              ...
              <div style={{
                ...
                <button
                  ...
                  style={{
                    ...
                    border: 'none',
                    borderRadius: '4px',
                    cursor: unsentCount === 0 || 1 < activeStep ? 'not-allowed' : 'pointer',
                    fontSize: '13px',
                    fontWeight: 'bold',
                  }}
                >
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', gap: '16px', alignItems: 'flex-start', marginBottom: '12px' }}>
                ...
                <div style={{
                  ...
                  <label style={{ ...labelStyle, fontWeight: 'bold', color: '#1f2937' }}>会計区分：</label>
                  <select
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px' }}>
                ...
                <input
                  ...
                  placeholder="0"
                  style={{ ...inputStyle, width: '120px', textAlign: 'right', fontVariantNumeric: 'tabular-nums' }}
                  disabled={!isStepEnabled(2) || 2 < activeStep}
                />
              ...
              <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
                <button
                  ...
                  style={{
                    padding: '10px 0',
                    width: '100%',
                    background: selectedFileName && quotationVendorName ? '#f8f9fa' : COLORS.disabledBg,
                    color: selectedFileName && quotationVendorName ? '#1f2937' : COLORS.textMuted,
                    border: `1px solid ${selectedFileName && quotationVendorName ? '#ccc' : COLORS.border}`,
                    borderRadius: '4px',
            ...
            <div style={{
              ...
              <div style={{ flex: 1 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  <label style={labelStyle}>決済No.：</label>
                  <input
                    type="text"
                    value={settlementNo}
                    onChange={(e) => setSettlementNo(e.target.value)}
                    placeholder="院内決済番号を入力"
                    style={{ ...inputStyle, flex: 1, background: '#fffde7' }}
                    disabled={!isStepEnabled(2) || 2 < activeStep}
                  />
                </div>
              </div>
              <div style={{ flexShrink: 0 }}>
                <div style={{ fontSize: '12px', fontWeight: 'bold', color: COLORS.textPrimary, marginBottom: '4px', textAlign: 'center' }}>
                  発注書の発行
                </div>
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
              <button
                ...
                style={{
                  ...
                  fontSize: '14px',
                  fontWeight: 'bold',
                  opacity: formData.deliveryDate && !isSubmitting ? 1 : 0.6,
                }}
              >
                作業日確定
              </button>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '16px', gap: '24px' }}>
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ fontSize: '14px', fontWeight: 'bold', color: COLORS.textPrimary }}>
                      {vendor?.vendorName || '（未設定）'}
                    </div>
                    <div style={{ fontSize: '12px', color: COLORS.textSecondary }}>
                      {vendor?.personInCharge || ''} 様
                    </div>
                  </div>
