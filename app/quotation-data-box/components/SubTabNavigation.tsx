...
export type SubTabType = 'remodelManagement' | 'purchaseManagement' | 'borrowingManagement' | 'transferManagement' | 'disposalManagement' | 'repairRequests' | 'makerMaintenance' | 'inHouseInspection' | 'lendingManagement';
