...
const initialAssets: AssetMaster[] = [
  ...
  // --- 内視鏡センター（rfqGroupId=4,8 発注品目対応） ---
  {
    id: 'ASSET021',
    category: '医療機器',
    largeClass: '手術関連機器',
    mediumClass: '内視鏡関連',
    item: '内視鏡システム EVIS X1',
    maker: 'オリンパス',
    model: 'CV-1500',
    specification: '4K対応プロセッサ、NBI/TXI搭載',
    unitPrice: 8800000,
    depreciationYears: 8,
    maintenanceCycle: 12,
    status: 'active',
  ...
  // --- リハビリ科（rfqGroupId=5 発注品目対応） ---
  {
    ...
    maker: 'キヤノンメディカル',
    model: 'US-750',
    specification: '1MHz/3MHz切替、連続/パルス出力',
    unitPrice: 1200000,
    depreciationYears: 6,
    maintenanceCycle: 24,
    status: 'active',
  ...
  },
  {
    ...
    largeClass: 'リハビリ機器',
    mediumClass: '水治療装置',
    item: 'ウォーターベッド型マッサージ器',
    maker: 'キヤノンメディカル',
    model: 'WB-300',
    specification: '全身マッサージ、水圧調整機能',
    unitPrice: 1800000,
    depreciationYears: 8,
    maintenanceCycle: 12,
    status: 'active',
  ...
  },
  {
    ...
    maker: 'キヤノンメディカル',
    model: 'PAD-EU-10',
    specification: '低周波治療器EU-910用導子セット',
    unitPrice: 45000,
    depreciationYears: 3,
    maintenanceCycle: 24,
    status: 'active',
  ...
  },
  {
    ...
    maker: 'キヤノンメディカル',
    model: 'PRB-US-5',
    specification: '超音波治療器US-750用プローブ',
    unitPrice: 85000,
    depreciationYears: 3,
    maintenanceCycle: 24,
    status: 'active',
