...
const sampleRequests: RepairRequest[] = [
  ...
  // 申請ステータスモーダル デモ用: 経営企画部 (ログインユーザー部署) 3件 (受付/依頼済/修理中 を網羅)
  {
    id: 'rep-101',
    requestNo: 'REP-20260301-001',
    ...
    model: 'ForceTriad',
    serialNo: 'SN-101001',
    installDepartment: '経営企画部',
    roomName: '会議室A',
    receptionDepartment: 'ME室',
    receptionPerson: '鈴木 太郎',
    receptionContact: '内線2345',
    status: '受付',
  ...
  },
  {
    ...
    alternativeDevice: '代替心電計 ECG-1500',
    alternativeReturnDate: '2026-03-08',
