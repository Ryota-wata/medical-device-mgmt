...
const sampleApplications: PurchaseApplication[] = [
  ...
  // 申請ステータスモーダル デモ用: 経営企画部 (ログインユーザー部署) 3件 (申請中/見積中/却下を網羅)
  {
    id: 'pa-101',
    applicationNo: 'AP-2026-0101',
    applicationType: '新規申請',
    applicantId: 'user-admin-001',
    applicantName: '佐藤 美智子',
    applicantDepartment: '経営企画部',
    ...
    applicationReason: '医療機器管理課の機能拡張に伴い、新規導入を希望します。',
    createdAt: '2026-03-02T10:00:00',
    updatedAt: '2026-03-02T10:00:00',
  },
  {
    id: 'pa-102',
    applicationNo: 'AP-2026-0102',
    applicationType: '増設申請',
    applicantId: 'user-admin-001',
    applicantName: '佐藤 美智子',
    applicantDepartment: '経営企画部',
    ...
    applicationReason: '保管容量不足解消のため増設を希望します。',
    createdAt: '2026-02-15T09:00:00',
    updatedAt: '2026-02-22T14:30:00',
  },
  {
    id: 'pa-103',
    applicationNo: 'AP-2026-0103',
    applicationType: '更新申請',
    applicantId: 'user-admin-001',
    applicantName: '佐藤 美智子',
    applicantDepartment: '経営企画部',
    ...
    section: '医療機器管理課',
    roomName: '事務室',
    desiredDeliveryDate: '2026-03-31',
    applicationReason: '老朽化のため更新を希望します。',
